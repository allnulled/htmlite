...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c22 = function(hijos) { return hijos },
      peg$c23 = "#",
      peg$c24 = peg$literalExpectation("#", false),
      peg$c25 = function(nombre) { return nombre },
      peg$c26 = ".",
      ...
      peg$c32 = function(estilos) { return estilos },
      peg$c33 = /^[A-Za-z_\-]/,
  ...
  function peg$parseSentencia_de_tag() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parseIdentificador_de_tag();
          if (s4 === peg$FAILED) {
            s4 = null;
          }
          if (s4 !== peg$FAILED) {
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          s12 = peg$parseHijos_de_tag_o_texto();
                          if (s12 === peg$FAILED) {
                            s12 = null;
                          }
                          if (s12 !== peg$FAILED) {
  ...
  function peg$parseTexto_de_tag() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parseTexto_de_tag_contenido();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseTexto_de_tag_contenido() {
    var s0, s1, s2, s3, s4;
